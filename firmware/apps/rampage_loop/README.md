...
Follow [Install and launch](../../../APPS.md#4-install-and-launch), copying this entire `rampage_loop` directory into the badge's `apps` folder. Select **Rampage Loop** in the menu and press **B**. The launcher supplies a default icon.

The folder must include `__init__.py` and all 48 PNG files inside `frames/`. No Wi-Fi, MP4 player, or firmware flashing is required.
